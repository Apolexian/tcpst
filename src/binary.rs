...
pub struct Channel<A, M>
where
    A: Action,
{
    pub sender: Box<dyn SendEndpoint<M>>,
    pub receiver: Box<dyn RecvEndpoint<M>>,
...
mod tests {
    ...
    use crate::binary::{Action, Branch, Channel, Offer, Recv, Reducable, Send, Tau, Terminate};

    use super::{RecvEndpoint, SendEndpoint};
